...
export const techstack = ["AI Data Stack", "ApplicationStack", "Platform Stack", "SkillStack"];
...
export const createLeadForm1: any = [
  ...
  //   placeholder: "Batch ID's of the batches he/she is enrolled in",
  //   typeValue: "text",
  //   type: "input",
  // },
  // {
  //   name: "sources",
  //   lableValue: "Source",
  //   data: FilterLableAndValue(Source),
  //   type: "select",
  // },
