...
const TaskDetail = ({
  ...
  const vaidation = () => {
    ...
    if (!trainerData?.taskOwner?.trim()) {
      formValid = false;
      newError["taskOwner"] = "Please enter task Owner";
    }
    if (!trainerData?.assignTo?.trim()) {
      formValid = false;
                ...
                >
                  {disableData?.[item?.name] ? (
                    <InputEdit
                      ...
                      value={
                        trainerData?.[item?.name]
                          ? (trainerData?.[item?.name] === "learnerId" ? learner : item?.data)?.filter(
                    ...
                    <SingleSelece
                      ...
                      data={item?.name === "trainerId" ? TrainerData : item?.name === "learnerId" ? learner : item?.data}
                    />
                  )}
                </div>
