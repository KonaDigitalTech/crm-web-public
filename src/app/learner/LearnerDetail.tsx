...
const LearnerDetail = ({
  ...
  const handelOnChange = (
    ...
    if (name1) {
      ...
      setLearnerData({ ...learnerData, [`${name}`]: name === "idProof" ? files?.[0] : value });
      setError({ ...error, [`${name}`]: "" });
    }
  };
  ...
  const handelOnSave = () => {
    if (vaidation()) {
      ...
      formData.append("name", learnerData?.name ? learnerData?.name : null);
      ...
      formData.append("batchId", learnerData?.batchId?.[0]?.value
        ...
        : learnerData?.batchId ? learnerData?.batchId : null);
      formData.append("phone", learnerData?.phone ? learnerData?.phone : null);
      formData.append("dateOfBirth", learnerData?.dateOfBirth ? learnerData?.dateOfBirth : '');
      formData.append("registeredDate", learnerData?.registeredDate ? learnerData?.registeredDate : '');
      formData.append("email", learnerData?.email ? learnerData?.email : null);
      formData.append("source", learnerData?.source ? learnerData?.source : null);
      formData.append("location", learnerData?.location ? learnerData?.location : null);
      formData.append("description", learnerData?.description ? learnerData?.description : null);
      formData.append("totalFees", learnerData?.totalFees ? learnerData?.totalFees : null);
      formData.append("modeofInstallmentpayment", learnerData?.modeofInstallmentpayment ? learnerData?.modeofInstallmentpayment : null);
      formData.append("feesPaid", learnerData?.feesPaid ? learnerData?.feesPaid : null);
      ...
      formData.append("dueAmount", learnerData?.dueAmount ? learnerData?.dueAmount : null);
      formData.append("dueDate", learnerData?.dueDate ? learnerData?.dueDate : '');
            ...
            {createLearnerForm?.map((item: any) => {
              return item?.type === "input" ? (
                <InputEdit
                  ...
                  type={item?.typeValue}
                  value={item?.name === "instalment1Screenshot" || item?.name === "idProof" ? learnerData?.[item?.name]?.name : learnerData?.[item?.name]}
                  onChange={item?.name === "instalment1Screenshot" ? handelOnChangeInstance : handelOnChange}
