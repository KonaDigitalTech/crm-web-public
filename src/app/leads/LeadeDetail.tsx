...
import { createLeadForm1, createLeadForm2, createLeadForm3, FilterLableAndValue } from "@/api/CommonData";
...
const LeadeDetail = ({
  ...
  console.log("🚀 ~ leadeData:", leadeData)
  ...
  const handelOnSave = () => {
    if (vaidation()) {
      ...
      const data = {
        ...
        fullNumber: leadeData?.fullNumber,
